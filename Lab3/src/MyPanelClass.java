...
//                        g.drawLine(width, 0, 0, height);
                        ...
                        //Width not in use test.
                        //System.out.println(width-55);
                        
                        //centered circle test.
                        //System.out.println((width-55)/2);
...
//                        g.drawPolygon(p2);
                        ...
                        g.drawRect(x1+10, y1+10, 200, 140);
                        g.setColor(Color.RED);
                        g.fillRect(x1+11, y1+11, 199, 139);
                        
                        g.setColor(Color.WHITE);
                        g.fillRect(x1+11, y1+39, 199, 27);
                        g.fillRect(x1+11, y1+96, 199, 27);
                        
                        Polygon triangle = new Polygon();
                        triangle.addPoint(x1+11, y1+11);
                        triangle.addPoint(x1+115, y1+80);
                        triangle.addPoint(x1+11, y1+150);
